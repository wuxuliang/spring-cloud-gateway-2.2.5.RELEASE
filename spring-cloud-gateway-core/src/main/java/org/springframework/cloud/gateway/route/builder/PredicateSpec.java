...
public class PredicateSpec extends UriSpec {
	...
	/**
	 * . A predicate which checks the remote address of the request. Useful if Spring
	 * Cloud Gateway site behind a proxy layer. Spring Cloud Gateway comes with one
	 * non-default remote address resolver which is based off of the
