...
public class RedisRateLimiter extends AbstractRateLimiter<RedisRateLimiter.Config>
	...
	/**
	 * . Whether or not to include headers containing rate limiter information, defaults
	 * to true.
	 */
	private boolean includeHeaders = true;

	/**
	 * . The name of the header that returns number of remaining requests during the
	 * current second.
	 */
	...
	/**
	 * . This uses a basic token bucket algorithm and relies on the fact that Redis
	 * scripts execute atomically. No other operations can run between fetching the count
	 * and writing the new count.
	 */
	@Override
	@SuppressWarnings("unchecked")
