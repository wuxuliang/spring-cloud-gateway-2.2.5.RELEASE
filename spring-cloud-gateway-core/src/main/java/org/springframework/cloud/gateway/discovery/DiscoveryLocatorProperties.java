...
public class DiscoveryLocatorProperties {
	...
	/**
	 * . The prefix for the routeId, defaults to
	 * discoveryClient.getClass().getSimpleName() + "_". Service Id will be appended to
	 * create the routeId.
	 */
	...
	/**
	 * . SpEL expression that create the uri for each route, defaults to:
	 * 'lb://'+serviceId.
	 */
	 ...
	 * Useful with eureka when it automatically uppercases serviceId. so MYSERIVCE, would
	 * match /myservice/**
	 */
